        ...
        public static void main(String[] args) {
                ...
                FastAutoGenerator.create(url, user, password)
                                ...
                                .strategyConfig(builder -> builder
                                                .addInclude("cart", "comment", "community", "game", "game_achievement",
                                                                "game_bundle",
                                                                "game_images", "game_price_history", "game_profile",
                                                                "game_tag", "gift",
                                                                "historical_orders", "message", "myorder",
                                                                "order_details", "payment_records", "post",
                                                                "sales", "tag", "user", "user_achievement",
                                                                "user_follow", "user_game_library",
                                                                "user_profile") // 指定要生成的表，改为你的表名或用 scanner 获取
                                                .entityBuilder().enableLombok()
                                                .controllerBuilder().enableRestStyle()
                                                .mapperBuilder().enableMapperAnnotation())
                                .templateEngine(new FreemarkerTemplateEngine()) // 使用 Freemarker，或改为
