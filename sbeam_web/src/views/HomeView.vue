...
/* 探索区卡片每行单个，左右布局 */
.game:nth-of-type(3) .product-box {
  display: flex;
  flex-direction: column; /* 每行一个卡片 */
  gap: 12px;
  padding: 10px;
...
/* 图片固定大小 */
.game:nth-of-type(3) .product-card img {
  width: 120px;
  height: 120px;
  object-fit: cover;
  border-radius: 8px;
...
/* 商品描述 */
.game:nth-of-type(3) .product-card .name,
.game:nth-of-type(3) .product-card .price {
  margin: 0;
}
