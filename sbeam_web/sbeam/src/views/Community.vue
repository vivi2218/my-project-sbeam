<template>
  <div class="community">
    ...
    <div class="tabs">
      <div class="tab" :class="{ 'active': activeTab === 'game-search' }" @click="activeTab = 'game-search'">根据游戏查询</div>
      <div class="tab" :class="{ 'active': activeTab === 'genre-search' }" @click="activeTab = 'genre-search'">根据游戏类型查询</div>
    </div>
